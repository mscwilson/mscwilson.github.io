...
[Here are all the basic details about it and how to use it]( https://guides.rubyonrails.org/active_record_basics.html). /Using ActiveRecord means not writing any SQL or Model code/. Feels a bit like cheating.
